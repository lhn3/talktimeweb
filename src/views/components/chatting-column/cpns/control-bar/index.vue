<template>
  <div
    ...
    :style="{ height: state.inputType ? `${(inputControlRef?.$el?.clientHeight || 0) + 10}px` : '42px' }"
  >
    <!--语音键盘输入-->
    ...
    <!--输入框-->
    <input-control ref="inputControlRef" v-if="state.inputType" v-model="state.inputValue" @submit="send" />
    <!--语音框-->
